...
class AddReservationScreen extends StatefulWidget {
  ...
  const AddReservationScreen({required this.labId, required this.place, Key? key}) : super(key: key);
...
class _AddReservationScreenState extends State<AddReservationScreen> {
  ...
  void _addReservation() {
    if (_formKey.currentState!.validate()) {
      ...
      context.read<LabDetailCubit>().addReservation(widget.place, year, day, from, to, doctor, lecture, widget.labId);
      Navigator.pop(context, true); // Return to previous screen after adding
    }
  }
        ...
        child: Form(
          ...
          child: ListView(
            children: [
              ...
              SizedBox(height: 16),
              BlocBuilder<LabDetailCubit, LabDetailState>(
