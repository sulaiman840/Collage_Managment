...
class UpdateReservationScreen extends StatefulWidget {
  ...
  const UpdateReservationScreen({required this.reservation, required this.labId, Key? key}) : super(key: key);

  @override
  _UpdateReservationScreenState createState() => _UpdateReservationScreenState();
}
...
class _UpdateReservationScreenState extends State<UpdateReservationScreen> {
  ...
  void _updateReservation() {
    if (_formKey.currentState!.validate()) {
      context.read<LabDetailCubit>().updateReservation(
